// *** Adjustments to use with Adafruit Motorshield V2 and Feather 328p
...
#define USE_DRIVER // *** Adjustments to use with Adafruit Motorshield V2
...
// read commands
bool eoc = false; // Triggers True after a new set of comands received
String line;
